        ...
        >
            ...
            <div className='max-w-4xl mx-auto mt-20 lg:mt-32'>
                ...
                <div className='flex justify-center mt-10'>
                    <Link href='/projects' className='transition-all duration-300 ease-in-out text-[11.5px] tracking-[2px] font-bold uppercase bg-blue-600 py-4 px-5 text-white hover:bg-white hover:text-blue-600 hover:shadow-2xl'>
                        Ver todos
                    </Link>
                </div>
            </div>
