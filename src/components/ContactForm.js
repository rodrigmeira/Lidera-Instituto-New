                    ...
                    <div className="lg:w-6/12 flex-1">
                        <form className="p-14 bg-white h-full">
                            ...
                            <div className="flex space-x-5">
                                ...
                                <div className="block mb-6">
                                    <input type="submit" className="cursor-pointer w-full block transition-all duration-300 ease-in-out text-[11.5px] tracking-[2px] font-bold uppercase bg-blue-600 py-4 px-5 text-white hover:bg-white hover:text-orange-600 hover:shadow-2xl" value="Enviar mensagem"/>
                                </div>
                        </form>
                    </div>
                </div>
