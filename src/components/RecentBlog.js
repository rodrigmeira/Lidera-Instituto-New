...
const recentBlogContent = {
  heading: {
    ...
    subtitle: "Nosso Blog",
    description:
      "Acompanhe as atualizações mais recentes do nosso blog, onde voce pode aprender tudo sobre a gestao publica ao qualificar profissionais da educacao e saude. Nossa equipe de especialistas tem o conhecimento e a experiencia necessarios para ajudar voce a alcancar seus objetivos de gestao publica.",
  },
};
    ...
    >
      ...
      <div className="p-8">
        <p className="text-gray-500 mb-3 uppercase text-[12px] tracking-[1px]">
          {format(parseISO(post.date), "dd MMM, yyyy")} • {post.author}
        </p>
        <h3 className="mb-4">
