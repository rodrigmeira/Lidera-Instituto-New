            ...
            <div className="container px-4 mx-auto">
                <div className="flex justify-center">
                    <div className="w-full max-w-2xl items-center mx-auto text-center">
                        ...
                        <p>
                            <Link href={cta_link} className="transition-all duration-300 ease-in-out inline-block text-[11.5px] tracking-[2px] font-bold uppercase bg-[#25bbfb] py-4 px-5 text-white hover:bg-white hover:text-blue-600 hover:shadow-2xl">
                                {cta_label}
                            </Link>
                        </p>
                    </div>
